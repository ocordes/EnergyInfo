...
def readVersion(path):
    ...
    version = today.strftime("%y%m%d") + "_energyinfo_"
    ver = ""
    for line in lines:
...
def htmlParts(file, header, nav, footer, version):
    ...
    #placeholders
    link = '<a target="_blank" href="https://github.com/ocordes/EnergyInfo/commits' + get_git_sha() + '">GIT SHA: ' + get_git_sha() + ' :: ' + version + '</a>'
